  ...
  return (
    <main>
      ...
      <section id="home" className="reference-home">
        ...
        <div className="reference-hero-copy"><h1>Designing how products earn trust,<br/><span>across visual, product &amp; growth.</span></h1><button className="reference-work" onClick={() => go('#work')}>See my work</button></div>
        <div className="reference-portrait-stage">
          <div className="portrait-placeholder" role="img" aria-label="Temporary portrait placeholder"><div className="portrait-head"/><div className="portrait-body"/></div>
          <svg className="reference-doodle" viewBox="0 0 420 150" aria-hidden="true"><path className="doodle-line" d="M18 92 C45 35 64 121 91 73 S142 45 161 86 S203 126 223 72 S273 36 296 84 S342 117 365 57 S394 38 407 71"/><path className="doodle-line second" d="M26 106 C57 69 72 128 104 91 S150 63 177 101 S215 124 242 91 S286 55 316 99 S355 117 394 81"/></svg>
        </div>
      </section>
