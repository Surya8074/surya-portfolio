  ...
  return (
    <section className={`genesis-hero ${loaded ? 'is-loaded' : ''}`}>
      ...
      <div className="genesis-hero-copy">
        ...
        <h1>GENESIS</h1>
        <p className="genesis-subtitle">Designing an AI-powered test automation workflow for modern QA teams.</p>
        <p className="genesis-description">
          A product experience that helps QA teams configure AI-powered testing while keeping people in control of the final validation.
        </p>
      </div>
        ...
        <div className="genesis-browser">
          ...
          <div className="genesis-dashboard">
            ...
            <div className="genesis-main-ui">
              <div className="genesis-ui-heading">
                <div><small>PROJECT / GENESIS</small><h2>Welcome back, Alex</h2></div>
              ...
              <div className="genesis-chart-row">
                <div className="genesis-panel genesis-chart">
                  <div className="genesis-panel-title"><strong>Test Execution Trend</strong><span>Last 30 days⌄</span></div>
                  <svg viewBox="0 0 620 180" preserveAspectRatio="none" aria-hidden="true">
                    <path d="M0 144 C40 132 52 95 92 111 S145 145 181 105 S224 64 267 90 S314 134 354 92 S410 45 454 74 S501 124 543 83 S581 40 620 54" />
                  </svg>
                  <div className="genesis-chart-labels"><span>Aug 01</span><span>Aug 15</span><span>Aug 30</span></div>
                </div>
                <div className="genesis-panel genesis-donut-panel">
                  <div className="genesis-panel-title"><strong>Test Results</strong><span>Today</span></div>
                  <div className="genesis-donut"><span>248<small>tests</small></span></div>
                  <div className="genesis-legend"><span><i /> Passed <b>72%</b></span><span><i /> Failed <b>08%</b></span><span><i /> Skipped <b>20%</b></span></div>
                </div>
              </div>
      ...
      <div className="genesis-hero-meta">
        {metadata.map(([label, value]) => <div key={label}><small>{label}</small><strong>{value}</strong></div>)}
      </div>
